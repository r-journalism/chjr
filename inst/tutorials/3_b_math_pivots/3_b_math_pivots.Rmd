---
title: "Class 2: Tidy data and math"
...
```{r quiz1, echo=FALSE}
quiz(caption = "Quiz 1",
  question("Which state saw the biggest increase in flood disaster declarations between '21 and '22?",
    answer('WA'),
    answer('MN', correct=T),
    answer('MT'),
    answer('LA'),
...
```{r quiz2, echo=FALSE}
quiz(caption = "Quiz 2",
  question("What's the percent change in flood disaster declarations between 2021 and 2022 so far this year",
    answer('25'),
    answer('-24.7', correct=T),
    answer('150'),
    answer('-5'),
    random_answer_order= TRUE
  ))
