...
Next up, load the csv `mcd_opioid_deaths.csv` (in the data folder) into your environment. Remember that you have to tell RStudio where the file is, relative to your .RProj file. You also have to assign it to a variable so that it can be stored in your environment.
